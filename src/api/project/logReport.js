...
export default {
  ///////////////////////////////////////隧道
  // 查询隧道子单位工程-是否上报进度
  queryTunnelSubUnitProgress(data) {
    return postRequest(baseUrl + "QueryTunnelSubUnitProgress", data);
  },
  // 上传天气
  ...
  ///////////////////////////////////////路基
  // 查询路基单位工程-是否上报日志
  queryRoadUnitProjectProgress(data) {
    return postRequest(baseUrl + "QueryRoadUnitProjectProgress", data);
  },
  // 上传天气
  ...
  ///////////////////////////////////////桥梁
  // 查询是否上报日志
  queryBridgeSubUnitProgress(data) {
    return postRequest(baseUrl + "QueryBridgeSubUnitProgress", data);
  },
  // 上传天气
