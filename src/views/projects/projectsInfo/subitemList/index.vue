      ...
      <div class="top-select-box">
        ...
        <div>
          <n-button
            ...
            "
          ></n-button>
          <n-button class="ml-1" :btnText="'上传'" v-permission="['ProjDetailListProjDetailDiff-upload']" @buttonClick="handleImport">
          </n-button>
          <n-button
            class="ml-1"
            :btnText="'下载'"
      ...
      <el-table
        ...
        <el-table-column label="操作" align="center" width="120">
          <template slot-scope="scope">
            <i
              @click.stop="
                $router.linkTo('project_projectsInfo_subitemList_editSubitem', {
  ...
  data() {
    return {
      ...
      listQuery: {
        page: 0,
        page_size: 20,
        proj_detail_diff_organ: this.$organ_id_en_or_pro(this),
