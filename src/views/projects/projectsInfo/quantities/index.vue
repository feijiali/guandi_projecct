...
export default {
  ...
  data() {
    return {
      ...
      listQuery: {
        page: 0,
        page_size: 20,
        proj_detail_main_organ: this.$organ_id_en_or_pro(this),
      }, //筛选条件
      params: {
        proj_detail_main_organ: this.$organ_id_en_or_pro(this),
  ...
  methods: {
    beforeClose() {
      this.params.proj_detail_main_organ = this.$organ_id_en_or_pro(this);
    ...
    Comdetail(id, type, orgin) {
      this.linkTo("project_projectsInfo_quantities_info", {
