      ...
      <n-scroll>
        <div>
          ...
          <div style="width:52%" class="float-right">
            ...
            <nInfoTitle title="操作人信息" class="mb-1" v-if="index == 6"/>
            <nInfoTitle title="检养信息" class="mb-1 mt-1" v-if="index == 7"/>
            <nInfoItem
  ...
  data() {
    return {
      dataInfoList: [
        ...
        {
          name: "检养时间",
          key: "maintain_check_time",
          islong: true,
        },
        {
          name: "检养人",
          key: "maintain_checker",
          islong: true,
        },
        {
          name: "下次检养时间",
          key: "device_next_check_time",
          islong: true,
        },
        {
          name: "检养内容",
          key: "maintain_check_content",
          islong: true,
        },
      ],
    };
