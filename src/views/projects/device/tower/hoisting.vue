  ...
  <div class="container-all">
    ...
    <div class="container-div">
      <div class="top-select-box">
        <div>
          <div class="d-inline-block">
            ...
            <el-select
              v-model="listQuery.tcw_alarm_type"
              placeholder="请选择"
              @change="refreshData"
            >
      ...
      <el-table
        ...
        <el-table-column label="采集时间" prop="tcw_time"></el-table-column>
        <el-table-column
          label="最大高度（m）"
          prop="tcw_max_height"
        ></el-table-column>
        ...
        <el-table-column
          label="最大重量（t）"
          prop="tcw_max_hoisting"
        ></el-table-column>
        <el-table-column
          label="最大力矩"
          prop="tcw_max_moment_of_force"
        ></el-table-column>
        <el-table-column
          label="力矩百分比"
          prop="tcw_percent"
        ></el-table-column>
        <el-table-column label="运行时长" prop="tcw_wind"></el-table-column>
        <el-table-column label="当前状态">
          <template slot-scope="scope">
            <span :class="colorArr[scope.row.tcw_alarm_type]">{{
              alarmArr[scope.row.tcw_alarm_type]
            }}</span>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  ...
  data() {
    return {
      postURL: "queryEquipmentTcWeight",
      dateRange: [
      ...
      listQuery: {
        // dev_type: 24,
        tcw_imei: this.$route.query.dev_name,
        page: 0,
        page_size: 20,
        tcw_alarm_type: 0,
