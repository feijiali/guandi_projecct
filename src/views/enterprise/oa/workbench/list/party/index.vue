  ...
  <div class="w-100 h-100 table-list-wrap">
    ...
    <div class="rounded-1 bg-white flex-fill">
      <div class="top-select-box">
        ...
        <div>
          <n-button
            v-permission="['UnionPartyPersonnelDevelop-upload']"
            :btnText="'草稿箱'"
            class="mr-2"
            @buttonClick="
              $router.linkTo('enterprise_oa_workbench_draft', {
                name: 'UnionPartyPersonnelDevelop',
              })
            "
          >
...
export default {
  ...
  data() {
    return {
      ...
      dateRange: [],
      keyID: "personnel_develop_id",
      getListBool: false,
    };
  },
  activated() {
    if (hasPermissionArr(["UnionPartyPersonnelDevelop-query"])) {
      //如果勾选查看权限，则能看所有的
