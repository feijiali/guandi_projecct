<template>
  <div class="w-100">
    ...
    <el-form class="el-form-box" ref="ruleforms" :inline="false">
      ...
      <el-form-item class="form-item-long-small must" label="家庭成员姓名：">
        <el-input
          class="input-m"
          v-model="ruleforms.subsidy_family_members"
          placeholder="请输入"
        ></el-input>
      </el-form-item>
      <el-form-item class="form-item-long-small must" label="住院原因：">
        <el-input
          class="input-m"
          v-model="ruleforms.subsidy_hospital_reason"
          placeholder="请输入"
        ></el-input>
      </el-form-item>
      <el-form-item class="form-item-long-small must" label="住院者姓名：">
        <el-input
          class="input-m"
          v-model="ruleforms.subsidy_hospitalization"
          placeholder="请输入"
        ></el-input>
      </el-form-item>
      <el-form-item class="form-item-long-small must" label="慰问项目：">
        <el-select
          v-model="ruleforms.subsidy_condolences_type"
          placeholder="请选择"
        >
          <el-option label="一般" :value="1"></el-option>
          <el-option label="重症" :value="2"></el-option>
        </el-select>
      </el-form-item>
      <el-form-item class="form-item-long-small must" label="慰问金额：">
        <num-input
          :isString="true"
          placeholder="请输入"
  ...
  data() {
    return {
      ruleforms: {
        ...
        subsidy_send_type: 1,
        subsidy_send_amount: "",
        subsidy_hospitalization: "",
        subsidy_condolences_type: "",
        subsidy_hospital_reason: "",
        subsidy_family_members: "",
