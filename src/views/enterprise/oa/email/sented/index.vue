 ...
 * @LastEditors: 邓易
 * @LastEditTime: 2021-03-29 11:47:15
-->
<template>
  <div class="bg-white w-100 h-100 rounded-1 p-1">
    ...
    <el-table
      ...
      <el-table-column
        ...
        width="200"
      ></el-table-column>
      <el-table-column label="已读人数" prop="oa_email_time" width="200">
        <template slot-scope="{ row }"
          >{{ row.read_count }}人</template
        ></el-table-column
      >
...
export default {
  ...
  methods: {
    ...
    rowclick(row) {
      this.linkTo("enterprise_oa_email_sented_info", { id: row.email_id });
    },
    searchFun(val) {
