 ...
 * @LastEditors: 邓易
 * @LastEditTime: 2021-03-31 10:18:14
-->
<template>
    ...
    <div style="height: calc(100% - 60px)">
      <n-scroll>
        <div class="">
          ...
          <!-- <n-button class="ml-2" :btnText="'删除'" colorBtn="orange" @buttonClick="changeState(1)">
            <template v-slot:button-slot>
...
export default {
  ...
  methods: {
    ...
    handleAdd(name_type) {
      let name = "enterprise_oa_email_dustbin" + name_type;
