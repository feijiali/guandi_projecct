 ...
 * @LastEditors: 邓易
 * @LastEditTime: 2021-03-29 10:03:49
-->
<template>
  <div class="position-relative h-100 w-100">
    <div class="position-absolute left-box rounded-1 bg-white px-2 py-1">
      <n-scroll>
        ...
        <el-form ref="ruleform" id="print" class="el-form-box mt-2">
