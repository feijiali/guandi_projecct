 ...
 * @LastEditors: 邓易
 * @LastEditTime: 2021-03-29 10:11:24
-->
<!--
 * @Autor: 邓易
 * @Date: 2021-03-03 10:24:51
    ...
    <div class="d-flex justify-content-between">
      <div>
        ...
        <div class="d-inline-block ml-2">
          ...
          <el-select v-model="listQuery.revise_info_state" placeholder="请选择" @change="refreshData">
...
export default {
  ...
  methods: {
    ...
    exportFun() {
      ...
      this.$utils.handleExport("ExportReceiveReceiveFile", this.listQuery, "已办发文");
    },
    handleSelectionChange(val) {
      this.sectionIds = val;
    },
    rowclick(row) {
      this.linkTo("enterprise_oa_document_done_info", { id: row.receive_file_id });
    },
    searchFun(val) {
