 ...
 * @LastEditors: 邓易
 * @LastEditTime: 2021-03-29 10:16:37
-->
<!--
 * @Autor: 邓易
 * @Date: 2021-03-03 10:24:51
      ...
      >
        <template slot-scope="{ row }">
          <span
            ...
            @click.stop="
              linkTo('enterprise_oa_document_monitor_reply_detail', {
...
export default {
  ...
  methods: {
    ...
    rowclick(row) {
      this.linkTo("enterprise_oa_document_monitor_info", {
        id: row.receive_file_id,
      });
    },
    searchFun(val) {
