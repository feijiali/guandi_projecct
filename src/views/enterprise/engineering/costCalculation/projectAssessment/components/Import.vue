<template>
  <n-scroll :native="false" class="w-100">
    <div class="mb-2 d-flex align-items-center">
      ...
      <a
        :href="
          GLOBAL.baseurl + '/MOULD/CostEstimationProjectAssessment_import.xlsx'
        "
        download="项目考核模版.xlsx"
      >
        <n-button
          :btnText="'下载模板'"
          :width="'150px'"
...
export default {
  ...
  data() {
    return {
      ...
      importURL: "ImportCostEstimationProjectAssessment",
      params: {
  ...
  methods: {
    checkFrom() {
      ...
      if (this.params.tab_exam_date == null) {
        this.$tip({
          isTip: true,
          message: "请选择月份!",
        });
