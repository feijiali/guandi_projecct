    ...
    <div class="container-div" style="margin: 0">
      ...
      <el-table :data="tableList" style="width: 100%" height="calc(100% - 85px)"
        ...
        <el-table-column
          ...
          prop="sub_unit_name"
        ></el-table-column>
        <el-table-column label="桩基（根）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_1.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_1.build_number"
          >
          </el-table-column>
          <el-table-column label="未完成" prop="detail_1.not_number">
          </el-table-column>
          <el-table-column label="完成率" prop="detail_1.ration">
          </el-table-column>
        </el-table-column>
        <el-table-column label="系梁（个）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_2.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_2.build_number"
          >
          </el-table-column>
          <el-table-column label="未完成" prop="detail_2.not_number">
          </el-table-column>
          <el-table-column label="完成率" prop="detail_2.ration">
          </el-table-column>
        </el-table-column>
        <el-table-column label="承台（个）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_3.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_3.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="墩柱（个）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_4.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_4.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="盖梁（个）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_5.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_5.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="台身（个）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_6.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_6.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="现浇段（节）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_7.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_7.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="预制梁（片）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_8.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_8.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="钢箱梁（片）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_9.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_9.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="耳背墙（个）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_10.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_10.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="台帽（个）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_11.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_11.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="扩大基础">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_12.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_12.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="湿接缝（个）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_13.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_13.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="预制板（个）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_14.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_14.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="斜拉索">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_15.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_15.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="拱圈（个）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_16.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_16.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="牛腿背墙（个）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_17.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_17.build_number"
          >
          </el-table-column>
        ...
        <el-table-column label="肋板（个）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_18.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_18.build_number"
          >
          </el-table-column>
          <el-table-column label="未完成" prop="detail_18.not_number">
          </el-table-column>
          <el-table-column label="完成率" prop="detail_18.ration">
          </el-table-column>
        </el-table-column>
        <el-table-column label="架梁（片）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_19.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_19.build_number"
          >
          </el-table-column>
          <el-table-column label="未完成" prop="detail_19.not_number">
          </el-table-column>
          <el-table-column label="完成率" prop="detail_19.ration">
          </el-table-column>
        </el-table-column>
        <el-table-column label="桥面系（㎡）">
          <el-table-column
            :label="activeIn == 0 ? '总计' : '计划'"
            prop="detail_20.plan_number"
          >
          </el-table-column>
          <el-table-column
            label="实际完成"
            min-width="90px"
            prop="detail_20.build_number"
          >
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    detailInitialFun(arr) {
      arr.forEach((item) => {
        for (let i = 0, len = item.balance.length; i < len; i++) {
          item[`detail_${item.balance[i].build_type}`] = item.balance[i];
          // item[`detail_${item.balance[i].build_type}`].not_number = (item[`detail_${item.balance[i].build_type}`].plan_number - item[`detail_${item.balance[i].build_type}`].build_number).toFixed(2);
          item[`detail_${item.balance[i].build_type}`].not_number =
            item[`detail_${item.balance[i].build_type}`].build_number >
            item[`detail_${item.balance[i].build_type}`].plan_number
              ? "0.00"
              : (
                  item[`detail_${item.balance[i].build_type}`].plan_number -
                  item[`detail_${item.balance[i].build_type}`].build_number
