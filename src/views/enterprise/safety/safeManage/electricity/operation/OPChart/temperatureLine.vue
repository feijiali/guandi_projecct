  ...
  methods: {
    linkTo() {
      ...
      if (leakage_protect.leakage_protect_id) {
        this.$router.linkTo(
          "enterprise_safety_safeManage_electricity_operation_acquisitionInfo",
          {
      ...
      api
        ...
        .then((res) => {
          ...
          if (this.caveats[0]) {
            ...
            this.$set(this.dataList[0], "data", [0, 0, 0, 0, 0]);
          }
        });
    },
    getSum() {
      ...
      let data = {
        query_type: 1,
        leakage_protect_realtime_date: this.listQuery
          .leakage_protect_realtime_date,
      ...
      api.queryIoTLeakageProtectRealtime(data).then((res) => {
        ...
        let data = res.result.map((item) => {
          return item[this.types[item.leakage_protect_realtime_type]]
            .temperature;
        });
