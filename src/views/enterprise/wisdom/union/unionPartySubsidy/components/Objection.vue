  ...
  data() {
    return {
      ruleform: {
        ...
        publicity_assess_type: 2, //1：困难职工 2:金秋助学
      },
    };
  },
  methods: {
    ...
    raiseObjection(row) {
      ...
      this.ruleform.publicity_account_id_un = row.subsidy_sub_account_id;
      this.ruleform.publicity_assess_id_un = row.subsidy_id;
      this.ruleform.publicity_assess_type = 2;
      this.$nextTick(() => {
