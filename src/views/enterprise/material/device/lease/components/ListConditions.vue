    ...
    <div>
      ...
      <div class="d-inline-block ml-2">
        ...
        <el-select
          ...
          v-model="conditions.equipment_lease_standing_book_depart"
          placeholder="请选择"
        >
          <el-option key="0" label="全部" :value="''"></el-option>
          <el-option
            v-for="item in partmentList"
            :key="item.equipment_lease_standing_book_depart"
            :label="item.equipment_lease_standing_book_depart"
            :value="item.equipment_lease_standing_book_depart"
          ></el-option>
        </el-select>
      </div>
      <div class="d-inline-block ml-2">
...
export default {
  ...
  data() {
    return {
      partmentKey: "equipment_lease_standing_book_depart",
      partmentApiName: "QueryEquipmentLeaseStandingBookDepart",
      conditions: {
        search: "",
        organ_node: this.$organ_id_en_or_pro(this),
        equipment_lease_standing_book_depart: "",
        start_time: "",
        end_time: "",
        page: 0,
        page_size: 20,
