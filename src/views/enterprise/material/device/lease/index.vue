<template>
  <div class="container-all">
    ...
    >
      <template slot="diaSlot">
        <FileImport ref="fileImport" @complete="handleImported"></FileImport>
      </template>
    </n-dialog>
...
export default {
  ...
  data() {
    return {
      dialogTitle: "导入租赁设备台账表",
      exportFileName: "租赁设备台账",
      postURL: "QueryEquipmentLeaseStandingBookList", //表格请求接口
      exportURL: "ExportEquipmentLeaseStandingBook",
      editRouteName: "enterprise_material2_device_lease_edit",
      listQuery: {
        search: "",
