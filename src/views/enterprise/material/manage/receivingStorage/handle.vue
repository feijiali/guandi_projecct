<template>
  <div class="w-100 h-100 table-list-wrap">
    ...
    <div class="rounded-1 bg-white flex-fill p-2">
      <n-scroll :native="false"
                class="h-100 form-box">
        <MaterialForm ref="rulforms"
                      :editID="editID"
                      @submitAllData="submitAllData"></MaterialForm>
        <v-approval-form @submitAllDataApproval="submitAllDataApproval"
                         ref="approval_form"
                         :modules_union="modules_union"
                         :type="1"
                         :titleName="titleName"></v-approval-form>
      </n-scroll>
    </div>
    <div class="d-flex justify-content-end mb-08">
      <n-button class="mt-1"
                ...
                :width="'150px'"
                :colorBtn="'blue'"
                @buttonClick="submitFun"></n-button>
    </div>
  </div>
</template>
