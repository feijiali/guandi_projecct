...
export default {
  computed: {
    show() {
      return hasPermissionArr(["SafeInspectionReport"]);
    },
    show2() {
      return hasPermissionArr(["SafeInspectionReport-upload"]);
    },
  },
  name: "",
  components: {},
  ...
  methods: {
    ...
    async TestInfo() {
      let res = await api.querySafeInspectionReport({
    ...
    handleTest() {
      ...
      this.$router.linkTo("HandleSafeTest", {
